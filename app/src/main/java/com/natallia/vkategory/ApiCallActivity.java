...
public class ApiCallActivity extends ActionBarActivity {
    ...
    VKRequestListener mRequestListener = new VKRequestListener() {
        ...
        public void onComplete(VKResponse response) {
            ...
            //VKList list  = (VKList)((VKApiGetMessagesResponse) response.parsedModel).items;
           ...
           // VKApiPost post  = postArray.get(0) ;
            ...
            ArrayAdapter <String> arrayAdapter = new ArrayAdapter<String>(ApiCallActivity.this, android.R.layout.simple_expandable_list_item_1,posts);
            getFragment().listView.setAdapter(arrayAdapter);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            listView = (ListView) v.findViewById(R.id.response);
            return v;
        }
    }
}